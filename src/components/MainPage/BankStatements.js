  ...
  return (
    <div className="w-full h-80 my-5 ">
      <div className="flex flex-col space-y-5 text-white">
        <div className="text-2xl">Legal Documents</div>
        <div className="w-3/4 self-end">
          <div class="flex items-center justify-center w-full">
            ...
            >
              <div class="flex items-center space-x-5 justify-between py-5">
                <svg
                  aria-hidden="true"
                ...
                <p class=" text-gray-500 dark:text-gray-400">
                  <span class="font-semibold">Click to upload</span> your Legal
                  documents
                </p>
              </div>
        ...
        <div className="text-2xl">Bank Statements</div>
        <div className="w-3/4 self-end">
          <div class="flex items-center justify-center w-full">
            <label
              for="dropzone-file"
